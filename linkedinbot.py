...
input_email.send_keys("digite seu email aqui")

input_psw = browser.find_element_by_id("password")
input_psw.send_keys("sua senha aqui")

btn_login = browser.find_element_by_xpath("//button[@type='submit']")
btn_login.click()

busca = browser.find_element_by_xpath("//button[@aria-label='Clicar para iniciar uma pesquisa']")
busca.click()
